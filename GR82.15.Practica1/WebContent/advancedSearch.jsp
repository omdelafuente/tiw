	...
	<div id="searchModal" class="w3-modal">
		<div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:650px">
			<div class="w3-center"><br>
        		<span onclick="document.getElementById('searchModal').style.display='none'" class="w3-button w3-xlarge w3-hover-red w3-display-topright">&times;</span>
        		<h3>Búsqueda avanzada</h3>
      		</div>
      		
      		<div class="w3-panel w3-red w3-card-4 form-errors" style="display:none">     		
      		</div>
    			...
    			<div class="w3-row">
      			...
      			<div class="w3-row">
      			    ...
      			    <div class="w3-container w3-half">
      					...
      					<input class="w3-input w3-border w3-light-grey w3-margin-bottom input-group" type="number" name="priceMin" min="0.0" max="9999.99" step=".01">
      				</div>
      				<div class="w3-container w3-half">
      					<label><b>Precio máximo</b></label>
      					<input class="w3-input w3-border w3-light-grey w3-margin-bottom input-group" type="number" name="priceMax" min="0.0" max="9999.99" step=".01">
      		   		</div>
      			</div>
      			<label><b>Texto en descripción</b></label>
      			<input name="description" class="w3-input w3-border w3-light-grey w3-margin-bottom input-group" type="text" maxlength="50"> 
...
$(document).ready(function () {
	...
	$("input[name='dateMin']").on('input', function() { 
		
	    $("input[name='dateMax']").attr("min",$(this).val());
	});
	$("input[name='dateMax']").on('input', function() { 
		
	    $("input[name='dateMin']").attr("max",$(this).val());
	});
	
	$("input[name='priceMin']").on('input', function() { 
		
	    $("input[name='priceMax']").attr("min",$(this).val());
	});
	$("input[name='priceMax']").on('input', function() { 
		
	    $("input[name='priceMin']").attr("max",$(this).val());
	});
