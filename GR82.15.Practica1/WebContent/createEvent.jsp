...
<div class="w3-main" style="margin-left:250px">
	...
	<div class="w3-container w3-center">
		...
		<form method="post" action="createEvent" id="createEventForm" enctype="multipart/form-data">
			<p>Título:</p>
    		<input class="w3-input w3-border w3-light-grey" style="width:50%; display:inline-block" type="text" name="title" placeholder="Mínimo un texto descriptivo de 8 letras" minlength="5" maxlength="50" required/><br>
    		...
    		<select name="category" class="w3-select w3-border w3-light-grey" style="width:50%; display:inline-block" required>
      		...
      		<input class="w3-input w3-border w3-light-grey" style="width:50%; display:inline-block" type="number" name="price" min="0.0" max="9999.99" step=".01" placeholder="Número entero o decimal con dos decimales" required/><br>
      		<p>Fecha y hora:</p>
    		...
    		<input class="w3-input w3-border w3-light-grey" style="width:50%; display:inline-block" type="text" name="place" placeholder="Mínimo un texto descriptivo de 8 letras" minlength="8" maxlength="50" required/><br>
